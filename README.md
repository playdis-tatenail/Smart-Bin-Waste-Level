...
Echo                     --->  GPIO 18 
## System Logic
- ระบบจะวัดระยะทาง 5 ครั้งแล้วหาค่าเฉลี่ยเพื่อลดความคลาดเคลื่อน   
- สูตรพยากรณ์: คำนวณจาก พื้นที่ว่างที่เหลือ / อัตราการเพิ่มขยะ (Fill Rate)
- ส่งข้อมูลไป Google Sheets และเช็กเงื่อนไขการแจ้งเตือนทุกๆ ช่วงเวลาที่กำหนด   
โปรเจกต์นี้เป็นส่วนหนึ่งของภาคการศึกษาที่ 2 ปีการศึกษา 2568
